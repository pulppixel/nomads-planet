...
namespace GameCreator.Runtime.Variables
{
    ...
    public class GlobalVariables
    {
        ...
        public void Editor_Set(GlobalNameVariables[] nameVariables, GlobalListVariables[] listVariables)
        {
            this.m_NameVariables = nameVariables;
            this.m_ListVariables = listVariables;
        }
